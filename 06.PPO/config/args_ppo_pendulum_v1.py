...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', type=str, default='Pendulum-v1', help='name of environment')
    ...
    parser.add_argument('--total_rollouts', type=int, default=300, help='num rollouts')
    ...
    # agent net
    parser.add_argument('--obs_dim', type=int, default=3, help='dimension od observaion')
