...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', type=str, default='CartPole-v1', help='name of environment')
    ...
    parser.add_argument('--entropy_coef', type=float, default=0.05, help='coef for general adversial estimator (GAE)')
    ...
    parser.add_argument('--rollout_len', type=int, default=500, help='num t-steps per one rollout')
    ...
    parser.add_argument('--batch_size', type=int, default=50, help='data batch size for weights updating')

    # agent net
    parser.add_argument('--obs_dim', type=int, default=4, help='dimension od observaion')
    ...
    parser.add_argument('--solved_reward', type=int, default=480, help='desired reward')
