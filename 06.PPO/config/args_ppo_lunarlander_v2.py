...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', type=str, default='LunarLander-v2', help='name of environment')
    ...
    parser.add_argument('--entropy_coef', type=float, default=0.03, help='coef for general adversial estimator (GAE)')
    ...
    parser.add_argument('--rollout_len', type=int, default=240, help='num t-steps per one rollout')
    parser.add_argument('--total_rollouts', type=int, default=20000, help='num rollouts')
    ...
    # agent net
    parser.add_argument('--obs_dim', type=int, default=8, help='dimension od observaion')
    ...
    parser.add_argument('--solved_reward', type=int, default=200+30, help='desired reward')
