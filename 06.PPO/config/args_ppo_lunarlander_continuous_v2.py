...
def get_args(rest_args):
    ...
    parser.add_argument('--env_name', type=str, default='LunarLanderContinuous-v2', help='name of environment')
    ...
    parser.add_argument('--entropy_coef', type=float, default=0.02, help='coef for general adversial estimator (GAE)')
    ...
    parser.add_argument('--rollout_len', type=int, default=320, help='num t-steps per one rollout')
    parser.add_argument('--total_rollouts', type=int, default=2000, help='num rollouts')
