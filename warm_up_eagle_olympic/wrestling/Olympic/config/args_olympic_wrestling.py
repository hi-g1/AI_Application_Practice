...
def get_args(rest_args):
    ...
    parser.add_argument('--rollout_len', type=int, default=10000, help='num t-steps per one rollout')
    parser.add_argument('--total_rollouts', type=int, default=100, help='num rollouts')
    ...
    parser.add_argument('--actor_lr', type=float, default=0.0005, help='learning rate for actor optimizer') # 0.0001
    parser.add_argument('--critic_lr', type=float, default=0.0005, help='learning rate for actor optimizer')

    # etc.
    parser.add_argument('--is_evaluate', type=boolean_argument, default=False, help='for evaluation')
    parser.add_argument('--solved_reward', type=int, default=999999999, help='desired reward') # -100
    ...
    parser.add_argument('--period_save_model', type=int, default=50, help='period_save_model')
    parser.add_argument('--load_model', type=boolean_argument, default=True, help='load previous model')
    parser.add_argument('--load_model_actor_path', type=str, default="train_history/olympics-wrestling/12_6_11_43/actor.pth", help='month_day_hour_minute')
    parser.add_argument('--load_model_critic_path', type=str, default="train_history/olympics-wrestling/12_6_11_43/critic.pth", help='month_day_hour_minute')
    parser.add_argument('--load_model_encoder_path', type=str, default="train_history/olympics-wrestling/12_6_11_43/encoder.pth", help='month_day_hour_minute')
