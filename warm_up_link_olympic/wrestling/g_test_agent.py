...
class link_wrestling_agent:
    def __init__(self):
        ...
        self.actor.load_state_dict(torch.load(
            "/Users/zzzanghun/git/AI_Application_Practice/warm_up_link_olympic/wrestling/train_history/olympics-wrestling/11_27_10_51/actor.pth",
            map_location=self.device))
        self.encoder.load_state_dict(torch.load(
            "/Users/zzzanghun/git/AI_Application_Practice/warm_up_link_olympic/wrestling/train_history/olympics-wrestling/11_27_10_51/encoder.pth",
            map_location=self.device))
