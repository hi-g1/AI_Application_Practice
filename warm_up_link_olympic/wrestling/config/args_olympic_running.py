...
def get_args(rest_args):
    ...
    parser.add_argument('--entropy_coef', type=float, default=0, help='coef for general adversial estimator (GAE)')
    parser.add_argument('--epsilon', type=float, default=0, help='clipping range for actor objective loss')
    ...
    parser.add_argument('--actor_lr', type=float, default=4e-4, help='learning rate for actor optimizer')
    parser.add_argument('--critic_lr', type=float, default=4e-4, help='learning rate for actor optimizer')

    # etc.
    parser.add_argument('--is_evaluate', type=boolean_argument, default=False, help='for evaluation')
    parser.add_argument('--solved_reward', type=int, default=5, help='desired reward')
