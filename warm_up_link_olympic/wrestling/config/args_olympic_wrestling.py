...
def get_args(rest_args):
    ...
    parser.add_argument('--entropy_coef', type=float, default=0.1, help='coef for general adversial estimator (GAE)')
    ...
    parser.add_argument('--entropy_coef_decay_rollout', type=float, default=0.005,
                        help='Percentage of total rollouts for entropy coefficient decay')

    # other hyperparameters
    parser.add_argument('--rollout_len', type=int, default=6000, help='num t-steps per one rollout')
    parser.add_argument('--total_rollouts', type=int, default=500, help='num rollouts')
    ...
    parser.add_argument('--actor_lr', type=float, default=1.2e-4, help='learning rate for actor optimizer')
    parser.add_argument('--critic_lr', type=float, default=1.2e-4, help='learning rate for actor optimizer')

    # etc.
    parser.add_argument('--is_evaluate', type=boolean_argument, default=True, help='for evaluation')
    parser.add_argument('--solved_reward', type=int, default=5000, help='desired reward')
    ...
    parser.add_argument('--load_model_time', type=str, default="11_27_10_51", help='month_day_hour_minute')
